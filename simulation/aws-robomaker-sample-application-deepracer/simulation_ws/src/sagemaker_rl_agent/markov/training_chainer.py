...
gym.envs.registration.register(id=defaults.ENV_ID, entry_point=defaults.ENTRY_POINT,
...
def main():
    ...
    parser.add_argument('--env', type=str, default=defaults.ENV_ID)
    parser.add_argument('--arch', type=str, default='FFMellowmax',
    ...
    parser.add_argument('--output-data-dir', type=str, default='./out')
    ...
    obs_normalizer = None #chainerrl.links.EmpiricalNormalization(
    ...
    if args.demo:
        ...
        experiments.train_agent_with_evaluation(
            ...
            outdir=args.output_data_dir,
            steps=args.steps,
            eval_n_steps=None,
            eval_n_episodes=args.eval_n_runs,
            # eval_n_runs=args.eval_n_runs, # for chainerrl 0.5.0
            eval_interval=args.eval_interval,
            train_max_episode_len=timestep_limit,
            # max_episode_len=timestep_limit,  # for chainerrl 0.5.0
